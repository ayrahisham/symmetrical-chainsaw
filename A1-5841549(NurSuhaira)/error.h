...
// Contains three simple functions:
void handle_error(cl::Error e);
void quit_program(const std::string str);
const std::string lookup_error_code(cl_int error_code);

// Use to catch exceptions (see this later in the main() function).
// It accepts a cl::Error object, 
// which allows us to obtain error information using two of its class functions:
...
void handle_error(cl::Error e)
{
	...
	// Calls the lookup_error_code() function to convert the error code 
	// into a string. This will make it easier to determine what caused the error
}

// simply displays an error message and quits the program
void quit_program(const std::string str)
{
